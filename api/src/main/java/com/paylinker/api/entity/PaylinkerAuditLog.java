...
@DynamoDbBean
public class PaylinkerAuditLog {
    ...
    public static String pk(String yyyyMmDd) {
        return "AUDIT#" + yyyyMmDd;
    }

    public static String sk(String timestamp, String auditId) {
    ...
    public static String gsi2Pk(String campaignId) {
